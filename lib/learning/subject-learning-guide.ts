import type { ProblemGuide, ProblemSnapshot, Subject } from "./types";

type GuideTemplate = Pick<ProblemGuide, "goal" | "approach" | "firstQuestion">;

const templates: Record<Subject, GuideTemplate> = {
...
export function subjectPendingGuide(problem: ProblemSnapshot): ProblemGuide {
