...
async function verifyTransfer(body: Record<string, unknown>, session: ReturnType<typeof openSession>, adapter: ReturnType<typeof getProviderAdapter>, now: string): Promise<Response> {
