...
function answerGate(kind, title, prompt, nodeId, answerChoices) {
    return {
        ...
        ...(kind === "transfer_answer" ? {} : { options: [...(kind === "solution_recall_answer" ? [{ id: "not_understood", label: "还没懂，再讲一下", emphasis: "secondary" }] : []), { ...boardOption }, { ...illustrationOption }, { ...understandingOptions[3] }] }),
    };
}
