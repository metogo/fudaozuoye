...
async function postConsent(request) {
    try {
        ...
        return new Response(JSON.stringify({ accepted: true, version: "guardian-v1", providers: (0, config_1.listProviderAvailability)(), reasoningLevels: (0, config_1.listReasoningAvailability)() }), { headers });
    }
    catch (error) {
