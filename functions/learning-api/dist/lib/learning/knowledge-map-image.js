...
exports.mapImageFrame = mapImageFrame;
function mapImageFrame(boxes) {
    if (!boxes.length || boxes.some(b => ![b.x, b.y, b.width, b.height].every(Number.isFinite) || b.width <= 0 || b.height <= 0))
        throw new Error("知识点尺寸尚未就绪，请稍后重试");
    ...
    if (pixelRatio < .75)
        throw new Error("节点摆放过于分散，请先点击“整理”再导出清晰图片");
